...
* Theme improvements: Improved escaping for some strings; Don't show settings links when Settings component is inactive; Fix some PHP notices; Fix bug that prevented admins from visiting a private group's Manage tab
