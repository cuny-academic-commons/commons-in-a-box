...
* Updated plugins: BP Group Announcements 1.0.4, BP Groupblog 1.8.9, BuddyPress 2.1.1, BuddyPress Docs 1.8.5, BuddyPress Docs Wiki add-on 1.0.8, BuddyPress Group Email Subcription 3.5, Invite Anyone 1.3.4
* Theme improvements: Fixed visibility issues related to activity tour popups generated by Joyride; Fixed bug that caused fatal error when parsing LESS stylesheets; Fixed bug that prevented header logo from showing up in recent versions of Chrome; Support for BuddyPress 2.1 @-mention autosuggest
