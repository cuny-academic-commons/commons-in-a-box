...
class CBox_Plugins_OpenLab {
	...
	protected static function register_required_plugins( $instance ) {
		...
		$instance( array(
			...
			'version'           => '1.1.0-beta1',
			'download_url'      => 'https://github.com/cuny-academic-commons/cbox-openlab-core/archive/1.1.0-beta1.zip',
			//'documentation_url' => 'http://commonsinabox.org/documentation/plugins/buddypress-plugin',
		) );
		...
		$instance( array(
			...
			'download_url'      => 'http://downloads.wordpress.org/plugin/buddypress-docs.2.1.0.zip',
	...
	protected static function register_dependency_plugins( $instance ) {
		...
		$instance( array(
			'plugin_name'  => 'BuddyPress',
			'type'         => 'dependency',
			'download_url' => 'http://downloads.wordpress.org/plugin/buddypress.3.1.0.zip'
		) );
	...
	protected static function register_optional_plugins( $instance ) {
		...
		$instance( array(
			...
			'version'           => '1.0-RC6',
			'depends'           => 'BuddyPress (>=1.5)',
			'download_url'      => 'https://github.com/r-a-y/bp-reply-by-email/archive/1.0-RC6.zip',
