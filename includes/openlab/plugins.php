...
class CBox_Plugins_OpenLab {
	...
	protected static function register_required_plugins( $instance ) {
		...
		call_user_func( $instance, array(
			...
			'version'           => '1.3.0-beta1',
			'download_url'      => 'https://github.com/cuny-academic-commons/cbox-openlab-core/archive/1.3.0-beta1.zip',
			//'documentation_url' => 'http://commonsinabox.org/documentation/plugins/buddypress-plugin',
		) );
		...
		*/
		...
		call_user_func( $instance, array(
			...
			'version'           => '1.1-beta2',
			'download_url'      => 'https://github.com/openlab-at-city-tech/openlab-portfolio/archive/1.1-beta2.zip',
		) );
	...
	protected static function register_dependency_plugins( $instance ) {
		...
		call_user_func( $instance, array(
			...
			'type'         => 'dependency',
			'version'      => '3.10.7',
			'download_url' => 'http://downloads.wordpress.org/plugin/event-organiser.3.10.5.zip',
			'network'      => false,
			'hide'         => cbox_is_main_site()
		) );
	...
	protected static function register_installonly_plugins( $instance ) {
		...
		call_user_func( $instance, array(
			...
			'version'           => '5.2.6',
			'download_url'      => 'http://downloads.wordpress.org/plugin/pressforward.5.2.6.zip',
		...
		call_user_func( $instance, array(
			...
			'version'           => '2.0.0-beta2',
			'download_url'      => 'https://github.com/openlab-at-city-tech/openlab-attributions/archive/2.0.0-beta2.zip',
		) );
		...
		call_user_func( $instance, array(
			...
			'version'           => '1.4.0',
			'download_url'      => 'http://downloads.wordpress.org/plugin/wp-grade-comments.1.4.0.zip',
