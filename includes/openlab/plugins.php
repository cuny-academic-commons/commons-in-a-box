...
class CBox_Plugins_OpenLab {
	...
	protected static function register_required_plugins( $instance ) {
		...
		call_user_func( $instance, array(
			...
			'version'           => '1.6.0-beta1',
			'download_url'      => CBOX_PLUGIN_DIR . 'includes/zip/cbox-openlab-core-1.6.0-beta1.zip',
			//'documentation_url' => 'http://commonsinabox.org/documentation/plugins/buddypress-plugin',
		) );
		...
		call_user_func( $instance, array(
			...
			'version'           => '1.0.3',
			'depends'           => 'BuddyPress (>=1.5)',
			'download_url'      => CBOX_PLUGIN_DIR . 'includes/zip/buddypress-docs-in-group-1.0.3.zip',
			'documentation_url' => 'http://commonsinabox.org/documentation/plugins/buddypress-docs',
			'network_settings'  => 'root-blog-only',
			'network'           => false,
		) );
		...
		call_user_func( $instance, array(
			...
			'download_url'      => 'http://downloads.wordpress.org/plugin/bp-group-documents.1.22.zip',
		...
		call_user_func( $instance, array(
			...
			'depends'           => 'BuddyPress (>=1.5)',
			'version'           => '4.1.0',
			'download_url'      => 'http://downloads.wordpress.org/plugin/buddypress-group-email-subscription.4.1.0.zip',
		...
		*/
		...
		call_user_func( $instance, array(
			...
			'version'           => '1.4.4',
			'depends'           => 'BuddyPress (>=1.5)',
			'download_url'      => 'http://downloads.wordpress.org/plugin/invite-anyone.1.4.4.zip',
		...
		call_user_func( $instance, array(
			...
			'version'           => '1.1.2',
			'download_url'      => CBOX_PLUGIN_DIR . 'includes/zip/openlab-portfolio-1.1.2.zip',
		) );
		...
		call_user_func( $instance, array(
			...
			'version'           => '1.0.1',
			'download_url'      => CBOX_PLUGIN_DIR . 'includes/zip/openlab-badges-1.0.1.zip',
		) );
		...
		call_user_func( $instance, array(
			...
			'version'           => '1.0.2',
			'download_url'      => CBOX_PLUGIN_DIR . 'includes/zip/openlab-email-embedded-media-1.0.2.zip',
		) );
	}
	...
	protected static function register_installonly_plugins( $instance ) {
		...
		call_user_func( $instance, array(
			...
			'version'           => '2.1.2',
			'download_url'      => CBOX_PLUGIN_DIR . 'includes/zip/openlab-attributions-2.1.2.zip',
		) );
