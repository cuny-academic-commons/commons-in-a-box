...
class CBox_Plugins_OpenLab {
	...
	protected static function register_required_plugins( $instance ) {
		...
		call_user_func( $instance, array(
			...
			'version'           => '1.5.0',
			'download_url'      => 'https://github.com/cuny-academic-commons/cbox-openlab-core/archive/1.5.0.zip',
			//'documentation_url' => 'http://commonsinabox.org/documentation/plugins/buddypress-plugin',
		) );
		...
		call_user_func( $instance, array(
			...
			'download_url'      => 'http://downloads.wordpress.org/plugin/buddypress-docs.2.2.0.zip',
		...
		*/
		...
		call_user_func( $instance, array(
			...
			'version'           => '1.1.2',
			'download_url'      => 'https://github.com/openlab-at-city-tech/openlab-portfolio/archive/1.1.2.zip',
		) );
	...
	protected static function register_installonly_plugins( $instance ) {
		...
		call_user_func( $instance, array(
			...
			'version'           => '2.1.2',
			'download_url'      => 'https://github.com/openlab-at-city-tech/openlab-attributions/archive/2.1.2.zip',
		) );
