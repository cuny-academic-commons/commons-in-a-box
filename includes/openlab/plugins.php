...
class CBox_Plugins_OpenLab {
	...
	protected static function register_required_plugins( $instance ) {
		...
		call_user_func( $instance, array(
			...
			'version'           => '2.6.11',
			'download_url'      => 'http://downloads.wordpress.org/plugin/bbpress.2.6.11.zip',
		...
		call_user_func( $instance, array(
			...
			'download_url'      => 'http://downloads.wordpress.org/plugin/buddypress-docs.2.2.4.zip',
	...
	protected static function register_dependency_plugins( $instance ) {
		...
		call_user_func( $instance, array(
			'plugin_name'  => 'BuddyPress',
			'type'         => 'dependency',
			'download_url' => 'http://downloads.wordpress.org/plugin/buddypress.14.2.1.zip'
		) );
	...
	protected static function register_installonly_plugins( $instance ) {
		...
		call_user_func( $instance, array(
			...
			'version'           => '5.7.0',
			'download_url'      => 'http://downloads.wordpress.org/plugin/pressforward.5.7.0.zip',
