...
<div id="getting-started" class="metabox-holder postbox">
	...
	<li>
		<h4><a href="<?php echo cbox_admin_prop( 'url', 'admin.php?page=cbox-ol-brand-settings' ); ?>"><?php esc_html_e( 'Visual Settings', 'cbox' ); ?></a></h4>
		<p><?php esc_html_e( 'Customize your site including color scheme, logo, homepage layout, footer content, and widgets.', 'cbox' ); ?></p>
	</li>
	<li>
		<h4><a href="<?php echo cbox_admin_prop( 'url', 'admin.php?page=cbox-ol-communication-settings' ); ?>"><?php esc_html_e( 'Communication', 'cbox' ); ?></a></h4>
