...
<p><?php
printf(
	// translators: 1. URL of the CUNY Graduate Center; 2. URL of New York City College of Technology; 3. URL of NEH ODH, 4. URL of the CUNY OER initiative, 5. URL of the BMCC OpenLab, 6. URL of SUNY Oneonta OpenLab.
	__( 'It was created through a collaboration between <a href="%1$s" target="_blank">The Graduate Center, CUNY</a> and <a href="%2$s" target="_blank">New York City College of Technology, CUNY</a> with funding from the National Endowment for the Humanities’ <a href="%3$s" target="_blank">Office of Digital Humanities</a>. Funding for continued development of new features has been provided by the <a href="%4$s" target="_blank">CUNY Open Educational Resources Initiative</a> and our partners at the <a href="%5$s" target="_blank">BMCC</a> and <a href="%6$s" target="_blank">SUNY Oneonta</a> OpenLabs.', 'commons-in-a-box' ),
