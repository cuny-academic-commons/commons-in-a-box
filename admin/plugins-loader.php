...
class CBox_Plugins {
	...
	private function register_recommended_plugins() {
		...
		self::register_plugin( array(
			...
			'depends'           => 'BuddyPress (>=1.5)',
			'version'           => '3.2.2',
			'download_url'      => 'http://downloads.wordpress.org/plugin/buddypress-group-email-subscription.3.2.2.zip',
		...
		self::register_plugin( array(
			...
			'version'           => '2.2.1',
			'download_url'      => 'http://downloads.wordpress.org/plugin/bbpress.2.2.1.zip',
