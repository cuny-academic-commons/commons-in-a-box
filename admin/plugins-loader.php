...
class CBox_Plugins {
	...
	private function register_recommended_plugins() {
		...
		self::register_plugin( array(
			...
			'download_url'      => 'http://downloads.wordpress.org/plugin/buddypress-docs.1.8.5.zip',
		...
		self::register_plugin( array(
			...
			'download_url'      => 'http://github.com/boonebgorges/buddypress-docs-wiki/archive/1.0.8.zip',
		...
		self::register_plugin( array(
			...
			'depends'           => 'BuddyPress (>=1.5)',
			'version'           => '3.5',
			'download_url'      => 'http://downloads.wordpress.org/plugin/buddypress-group-email-subscription.3.5.zip',
		...
		self::register_plugin( array(
			...
			'version'           => '1.3.4',
			'depends'           => 'BuddyPress (>=1.5)',
			'download_url'      => 'http://downloads.wordpress.org/plugin/invite-anyone.1.3.4.zip',
		...
		self::register_plugin( array(
			...
			'version'           => '2.5.6',
			'download_url'      => 'http://downloads.wordpress.org/plugin/bbpress.2.5.6.zip',
		...
		if ( is_network_admin() ) :
			...
			self::register_plugin( array(
				...
				'version'           => '1.8.10',
				'download_url'      => 'http://downloads.wordpress.org/plugin/bp-groupblog.1.8.10.zip',
	...
	private function register_dependency_plugins() {
		...
		self::register_plugin( array(
			'plugin_name'  => 'BuddyPress',
			'type'         => 'dependency',
			'download_url' => 'http://downloads.wordpress.org/plugin/buddypress.2.1.1.zip'
		) );
	}
