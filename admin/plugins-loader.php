...
class CBox_Plugins {
	...
	private function register_recommended_plugins() {
		...
		self::register_plugin( array(
			...
			'download_url'      => 'http://downloads.wordpress.org/plugin/buddypress-docs.1.9.1.zip',
		...
		self::register_plugin( array(
			...
			'version'           => '1.3.11',
			'depends'           => 'BuddyPress (>=1.5)',
			'download_url'      => 'http://downloads.wordpress.org/plugin/invite-anyone.1.3.11.zip',
		...
		self::register_plugin( array(
			...
			'version'           => '2.5.10',
			'download_url'      => 'http://downloads.wordpress.org/plugin/bbpress.2.5.10.zip',
	...
	private function register_dependency_plugins() {
		...
		self::register_plugin( array(
			'plugin_name'  => 'BuddyPress',
			'type'         => 'dependency',
			'download_url' => 'http://downloads.wordpress.org/plugin/buddypress.2.6.2.zip'
		) );
	}
